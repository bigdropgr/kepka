...
class ELearning_Lesson_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        $title = !empty($instance['title']) ? $instance['title'] : 'Πρόσφατα Άρθρα';
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">Αριθμός άρθρων για εμφάνιση:</label>
