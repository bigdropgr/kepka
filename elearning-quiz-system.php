 ...
 * Description: Ένα ολοκληρωμένο σύστημα e-learning με άρθρα, κουίζ και αναλυτικά στοιχεία για το WordPress. / A comprehensive e-learning system with lessons, quizzes, and analytics for WordPress.
 * Version: 1.2.0
 * Author: BigDrop
...
define('ELEARNING_QUIZ_VERSION', '1.1.0');
...
class ELearningQuizSystem {
    ...
    private function getFrontendStrings(): array {
        return [
            ...
            // NEW: Review lesson strings
            'review_lesson' => __('Επανάληψη Άρθρου', 'elearning-quiz'),
            'review_lesson_suggestion' => __('Προτείνουμε να επαναλάβετε το άρθρο πριν δοκιμάσετε ξανά το κουίζ.', 'elearning-quiz'),
            'view_lesson_again' => __('Δείτε Ξανά το Άρθρο', 'elearning-quiz'),
            
            // Section strings (existing)
